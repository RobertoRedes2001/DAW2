...
export class MainComponent {
  public fruitNames : string[] = ["Platano","Kiwi","Manzana","Pera"];
  public vegetableNames : string[] = ["Lechuga","Tomate","Berenjena","Cebolla"];

  public fruitImgs  : string[] = [
  ...
  public onToggleModal(name:string,img:string){
